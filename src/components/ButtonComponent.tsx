...
export const ButtonComponent: FC<props> = ({ disabled }) => {
    ...
    return (
        <button
            disabled={disabled}
            className={`w-full basis-14 flex-shrink-0 rounded-md bg-blue-700 disabled:bg-gray-800 disabled:hover:bg-green-800 hover:bg-green-700  enabled:focus:bg-green-700 
