  ...
  return (
    <header id="header" className={`${styles.headerBackground} flex items-center justify-center h-[70vh] sm:aspect-16/8 sm:h-auto`}>
      <div className=" flex flex-col items-center relative gap-4">
        ...
        <h1 className={`${styles.interFont} ${styles['text-shadow']} text-center text-[34px]/snug sm:text-[38px]/snug md:text-[42px]/snug lg:text-[50px]/snug xl:text-6xl/snug`}>SAVE AMAZING <br className='lg:hidden' /> AMAZONAS</h1>
      </div>
    </header>
  );
};
