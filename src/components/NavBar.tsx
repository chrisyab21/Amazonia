...
export const NavBar = () => {
    ...
    return (
        <nav className={`bg-Verde relative z-50 w-full md:fixed border-black ${scrolled ? 'border-b-[1px] border-black border-opacity-40' : 'md:bg-transparent'} transition-colors duration-500`} ref={navBarRef} >
