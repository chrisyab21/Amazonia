...
export const VisionCard = () => {
  return (
    ...
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-lime-950 dark:border-green-950">
      <div className="flex flex-col px-4 bg-opacity-40 bg-green-800">
        <a href="#">
