  ...
  return (
    <section id="mission" className="flex justify-center items-center bg-AzulOscuro p-20 px-14 sm:px-16 md:px-20 gap-10 md:gap-6 lg:gap-20">
      <div className=" flex flex-col justify-center items-center gap-8 md:w-10/12 lg:w-6/12">
        <h5 className={`mb-2 font-roboto font-semibold text-2xl text-center tracking-widest text-white dark:text-white ${styles['text-shadow']}`}>MISION</h5>
        <p className="mb-3 font-roboto font-normal text-justify text-lg text-gray-300 leading-10 dark:text-gray-300">
